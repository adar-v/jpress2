    ...
    public void index() {
        ...
        Page<Article> page =
                StringUtils.isBlank(status)
                        ? articleService._paginateWithoutTrash(getPagePara(), 2, title, categoryId)
                        : articleService._paginateByStatus(getPagePara(), 2, title, categoryId, status);
        System.out.println(getPagePara());
