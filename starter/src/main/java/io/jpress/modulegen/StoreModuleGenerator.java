 ...
 */
public class StoreModuleGenerator {
    ...
    private static String moduleName = "store";
    private static String dbTables = "brands,commodity";
    private static String modelPackage = "io.jpress.module.store.model";
    private static String servicePackage = "io.jpress.module.store.service";
